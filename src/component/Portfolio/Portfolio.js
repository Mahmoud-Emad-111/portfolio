    ...
    return(
        <div className="portfolio">
                ...
                <div className="p-right">
                    ...
                    <Box img={dashboard} head="ecommbers" link="https://mix-dun.vercel.app/" desc="Online store for selling products. With a beautiful and responsive design no-backend "/>
                    <Box img={mix} head="ecommbers" link="https://dashboard-app-73c0f.web.app/" desc="Dashboard Multi-page with a beautiful design, responsive and easy to use "/>
